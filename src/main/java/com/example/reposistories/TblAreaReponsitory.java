...
public interface TblAreaReponsitory extends JpaRepository<TblAreaEntity, Long> {
    ...
    void updateTblArea(String areaKana, String area, long cityId, int chomeArea, int koazaArea, int multiPostArea, long postId, long oldPostId, long areaId);
    ...
    @Query(value = "INSERT INTO tbl_area(area_kana, area, city_id, chome_area, koaza_area, multi_post_area, post_id, old_post_id) "
            + "VALUES(:areaKana, :area, :cityId, :chomeArea, :koazaArea, :multiPostArea, :postId, :oldPostId)",
            nativeQuery = true)
    ...
    String getAreaKanaById(long areaId);
